...
*/
console.log("Is the empty tree empty?")
console.log(emptyTree.isEmpty());
console.log();

console.log("Is the one node tree empty?")
console.log(oneNodeTree.isEmpty());
console.log();

console.log("Testing min and min recursive on one node tree");
console.log(oneNodeTree.min());
console.log(oneNodeTree.minRecursive());
console.log();

console.log("Testing max and max recursive on one node tree");
console.log(oneNodeTree.max());
console.log(oneNodeTree.maxRecursive());
console.log();

console.log("Testing min and min recursive on three level tree");
console.log(threeLevelTree.min());
console.log(threeLevelTree.minRecursive());
console.log();

console.log("Testing max and max recursive on three level tree");
