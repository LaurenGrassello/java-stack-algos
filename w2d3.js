    ...
    insert(newVal) {
        ...
        while (curr) {
            if (newVal < curr.data) {
                if (!curr.left) {
                    curr.left = newNode;
                    return newVal + " has successfully been added";
                }
                else {
                    curr = curr.left;
                }
...
console.log("Trying to insert a smaller number");
console.log(oneNodeTree.insert(2));
oneNodeTree.print();
console.log();

console.log("Trying to insert a middle number");
console.log(oneNodeTree.insert(8));
oneNodeTree.print();
console.log();

console.log("Trying to insert smallest number");
console.log(oneNodeTree.insert(1));
oneNodeTree.print();
console.log();

console.log("Trying to insert larger number");
console.log(oneNodeTree.insertRecursive(15));
oneNodeTree.print();
console.log();